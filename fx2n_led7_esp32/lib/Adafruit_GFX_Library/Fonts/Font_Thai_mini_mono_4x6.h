const uint8_t Font_Thai_mini_mono_4x6Bitmaps[] PROGMEM = {
  ...
  0x3C, 0x37, 0xCD, 0xE0, 0x49, 0x27, 0x92, 0x49, 0x20, 0x22, 0x22, 0x22, 
  0x7C, 0x61, 0x86, 0xD9, 0xC0, 0xCF, 0x6F, 0x3C, 0xDB, 0x30, 0xC6, 0x31, 
  0x8C, 0x7C, 0x8E, 0xEB, 0x18, 0xC4, 0x00, 0x00, 0x09, 0x34, 0xB2, 0x49, 
  0x24, 0x7B, 0x3C, 0xF3, 0xCD, 0xE0, 0xFB, 0x3C, 0xFE, 0xC3, 0x00, 0x7B, 
  0x3C, 0xF3, 0xD9, 0xD0, 0xFB, 0x3C, 0xFE, 0xCF, 0x30, 0x7B, 0x17, 0x83, 
  0xCD, 0xE0, 0xE2, 0x10, 0x84, 0x20, 0x00, 0xCF, 0x3C, 0xF3, 0xCD, 0xE0, 
  ...
  0xD1, 0x80, 0x31, 0x69, 0x69, 0x9F, 0x99, 0x00, 0x20, 0x40, 0x1E, 0xCF, 
  0x3F, 0xF3, 0xCC, 0x00, 0x7B, 0x3C, 0xFF, 0xCF, 0x30, 0x08, 0x72, 0x7A, 
  0x94, 0xB8, 0x00, 0x7B, 0x3C, 0xFF, 0xCF, 0x30, 0x08, 0x25, 0x0F, 0x8F, 
  0x88, 0xF2, 0x06, 0x96, 0x99, 0x99, 0x64, 0x00, 0x00
};

const GFXglyph Font_Thai_mini_mono_4x6Glyphs[] PROGMEM = {
  {     0,   0,   0,   2,   -2,    1 },   // 0x20 ' '
  {     2,   2,   6,   8,    3,   -5 },   // 0x21 '!'
  {     4,   4,   3,   8,    2,   -5 },   // 0x22 '"'
  {     6,  10,  11,  12,    0,   -5 },   // 0x23 '#'
  ...
  {   410,   4,  11,   5,    1,   -6 },   // 0xBE '¾'
  {     0,   0,   0,   0,    0,    0 },   // 0xBF '¿'
  {   416,   6,   9,   6,    0,   -8 },   // 0xC0 'À'
  {     0,   0,   0,   0,    0,    0 },   // 0xC1 'Á'
  {     0,   0,   0,   0,    0,    0 },   // 0xC2 'Â'
  {     0,   0,   0,   0,    0,    0 },   // 0xC3 'Ã'
  {   424,   6,   8,   6,    0,   -5 },   // 0xC4 'Ä'
  {     0,   0,   0,   0,    0,    0 },   // 0xC5 'Å'
  {     0,   0,   0,   0,    0,    0 },   // 0xC6 'Æ'
  {     0,   0,   0,   0,    0,    0 },   // 0xC7 'Ç'
  {     0,   0,   0,   0,    0,    0 },   // 0xC8 'È'
  ...
  {     0,   0,   0,   0,    0,    0 },   // 0xE2 'â'
  {     0,   0,   0,   0,    0,    0 },   // 0xE3 'ã'
  {   435,   6,   8,   6,    0,   -5 },   // 0xE4 'ä'
  {     0,   0,   0,   0,    0,    0 },   // 0xE5 'å'
  {     0,   0,   0,   0,    0,    0 },   // 0xE6 'æ'
  {     0,   0,   0,   0,    0,    0 },   // 0xE7 'ç'
  {     0,   0,   0,   0,    0,    0 },   // 0xE8 'è'
  {   441,   4,  10,   5,    1,   -8 },   // 0xE9 'é'
  {     0,   0,   0,   0,    0,    0 },   // 0xEA 'ê'
  {     0,   0,   0,   0,    0,    0 },   // 0xEB 'ë'
  {     0,   0,   0,   0,    0,    0 },   // 0xEC 'ì'
  {     0,   0,   0,   0,    0,    0 },   // 0xED 'í'
  ...
  {     0,   0,   0,   0,    0,    0 },   // 0xFC 'ü'
  {     0,   0,   0,   0,    0,    0 },   // 0xFD 'ý'
  {   452,   1,   1,   4,    0,   -6 }    // 0xFE 'þ'
};

const GFXfont Font_Thai_mini_mono_4x6 PROGMEM = {
  (uint8_t  *)Font_Thai_mini_mono_4x6Bitmaps,  
  (GFXglyph *)Font_Thai_mini_mono_4x6Glyphs, 0x20, 0xFE,   9 };
